...
namespace ELearning.Controllers
{
    public class TechnologiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdProfessor,Name,UrlImage")] Technology technology)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,IdProfessor,Name,UrlImage")] Technology technology)
        {
            if (id != technology.Id)
            {
                return NotFound();
